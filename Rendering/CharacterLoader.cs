...
/// never decode a character's full footage when a fraction is used. The returned sprites own native
/// bitmaps and must be <see cref="CharacterSprites.Dispose">disposed</see> when swapped out.
/// </summary>
public static class CharacterLoader
{
    public static CharacterSprites? Load(CharacterStore store, string? id,
        IReadOnlyCollection<string>? poses)
    {
